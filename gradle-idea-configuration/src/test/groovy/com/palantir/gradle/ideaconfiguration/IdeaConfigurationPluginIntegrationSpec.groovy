...
class IdeaConfigurationPluginIntegrationSpec extends IntegrationSpec {
    ...
    def "creates if externalDependencies.xml is malformed"() {
        //language=gradle
        buildFile << """
             ideaConfiguration {
                externalDependencies {
    ...
    def "creates if externalDependencies.xml if missing plugins"() {
        //language=gradle
        buildFile << """
             ideaConfiguration {
                externalDependencies {
    ...
    def "creates if externalDependencies.xml if missing component"() {
        //language=gradle
        buildFile << """
             ideaConfiguration {
                externalDependencies {
